...
public class MoneroLwsAdminParams
{
    ...
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    [JsonPropertyName("view_public_hex")]
    public string ViewPublicHex { get; set; } = "";

    /// <summary>
    /// Address public spend as hex.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    [JsonPropertyName("spend_public_hex")]
    public string SpendPublicHex { get; set; } = "";

    /// <summary>
    /// Address view key as hex.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    [JsonPropertyName("view_key_hex")]
    public string ViewKeyHex { get; set; } = "";
}