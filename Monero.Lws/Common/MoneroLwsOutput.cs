...
public class MoneroLwsOutput
{
    ...
    public long GlobalIndex { get; set; } = 0;
    ...
    [JsonPropertyName("tx_prefix_hash")]
    ...
    [JsonPropertyName("spend_key_images")]
    public List<string> SpendKeyImages { get; set; } = [];
    ...
    public MoneroLwsAddressMeta Recipient { get; set; } = new();
}