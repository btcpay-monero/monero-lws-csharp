...
public class MoneroLwsVersion
{
    ...
    /// </summary>
    [JsonPropertyName("last_git_commit_hash")]
    public string LastGitCommitHash { get; set; } = "";

    /// <summary>
    /// Implementation defined commit date.
    /// </summary>
    [JsonPropertyName("last_git_commit_date")]
    public string LastGitCommitDate { get; set; } = "";

    /// <summary>
    /// Implementation defined branch name.
    /// </summary>
    [JsonPropertyName("git_branch_name")]
    public string GitBranchName { get; set; } = "";

    /// <summary>
    /// Implementation defined version string.
    /// </summary>
    [JsonPropertyName("monero_version_full")]
    public string MoneroVersionFull { get; set; } = "";
    ...
    /// </summary>
    [JsonPropertyName("max_subaddresses")]
    public long MaxSubaddresses { get; set; } = 0;
